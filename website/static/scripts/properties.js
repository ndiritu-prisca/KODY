document.addEventListener("DOMContentLoaded", function() {
  ...
  const propertyContainers = document.querySelectorAll(".property-carousel");
  ...
  function filterProperties() {
      ...
      // Check if any child element matches the selected filters
      ...
      // Hide or show the property container based on the selected filters
      container.closest('.col-md-4').style.display = matchesFilters ? "block" : "none";
      });
  }
